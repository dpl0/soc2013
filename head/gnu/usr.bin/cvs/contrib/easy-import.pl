...
#
# $FreeBSD: soc2013/dpl/head/gnu/usr.bin/cvs/contrib/easy-import.pl 51006 1999-09-05 17:35:31Z peter $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: soc2013/dpl/head/gnu/usr.bin/cvs/contrib/easy-import.pl 51006 1999-09-05 17:35:31Z peter $' . "\n"; # 'emacs kludge
	exit 0;
    }
