...
# $FreeBSD: soc2013/dpl/head/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226716 2011-10-16 14:30:28Z eadler $
...
echo '# $FreeBSD: soc2013/dpl/head/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226716 2011-10-16 14:30:28Z eadler $' >> Makefile.hfs
...
echo '$FreeBSD: soc2013/dpl/head/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226716 2011-10-16 14:30:28Z eadler $' >> $OUTPUT_FILE.bz2.uu
