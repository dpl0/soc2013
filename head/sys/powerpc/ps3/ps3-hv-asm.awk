...
# $FreeBSD: soc2013/dpl/head/sys/powerpc/ps3/ps3-hv-asm.awk 228970 2011-12-18 16:53:03Z nwhitehorn $

BEGIN {
	printf("/* $FreeBSD: soc2013/dpl/head/sys/powerpc/ps3/ps3-hv-asm.awk 228970 2011-12-18 16:53:03Z nwhitehorn $ */\n\n");
