...
# $FreeBSD: soc2013/dpl/head/release/powerpc/generate-hfs.sh 221509 2011-05-04 23:34:10Z nwhitehorn $
...
echo '$FreeBSD: soc2013/dpl/head/release/powerpc/generate-hfs.sh 221509 2011-05-04 23:34:10Z nwhitehorn $' >> $OUTPUT_FILE.bz2.uu
